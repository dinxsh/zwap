...
export class ZcashClient {
  ...
  constructor(config: ZcashConfig) {
    ...
    this.connection = validated.connection || new Connection(validated.solanaRpcUrl);
   ...
   */
  async getDepositAddress(userSolanaAddress: PublicKey): Promise<{ zcashDepositAddress: string }> {
