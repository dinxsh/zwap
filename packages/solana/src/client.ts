...
export class SolanaClient {
  ...
  getProvider(wallet?: { publicKey: PublicKey; signTransaction: any; signAllTransactions: any }): AnchorProvider {
    ...
    if (!this.provider) {
      throw new Error("Provider not initialized. Pass a wallet to getProvider()");
    }
